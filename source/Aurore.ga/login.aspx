<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="Aurore.ga.login" %>
...
<head runat="server">
    ...
    <title>Aurore.ga - 관리자</title>
</head>
<body>
    <form id="form1" runat="server" class="form-signin">
        <h1 class="h3 mb-1 font-weight-normal text-center">Aurore.ga</h1>
